...
class ParkingSpace():
    ...
    def slotAnalysis(self):
        #read csv file
        df = pd.read_csv(self.csv_file, parse_dates=['Entry_Time', 'Exit_Time'])
